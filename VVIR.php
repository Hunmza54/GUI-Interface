...
<body>
    ...
    <h2>Change Parameters</h2>
        ...
        <form method="post">
            ...
            Maximum Sensing Rate (ppm): <input type="range" name="maximum_sensor_rate" placeholder= "Maximum Sensing Rate" min="50" max="175" step="1" value="50" oninput="rangeValue9.innerText = this.value" required>
            <br>
